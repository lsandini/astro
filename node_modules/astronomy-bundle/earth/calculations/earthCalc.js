...
var calculations_2 = require("../../moon/calculations");
...
function getNutationInLongitude(T) {
    var D = calculations_2.moonCalc.getMeanElongation(T);
    var Msun = calculations_3.sunCalc.getMeanAnomaly(T);
    var Mmoon = calculations_2.moonCalc.getMeanAnomaly(T);
    var F = calculations_2.moonCalc.getArgumentOfLatitude(T);
    var O = 125.04452
        - 1934.136261 * T
        + 0.0020708 * Math.pow(T, 2)
        + Math.pow(T, 3) / 450000;
    var sumPhi = 0;
    calculations_1.EARTH_ARGUMENTS_OF_NUTATION.forEach(function (args) {
        var argMmoon = args[0];
        var argMsun = args[1];
        var argF = args[2];
        var argD = args[3];
