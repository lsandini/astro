...
var Moon = (function (_super) {
    ...
    function Moon(toi) {
        var _this = _super.call(this, 'moon', toi) || this;
    ...
    Moon.prototype.getRise = function (location, standardAltitude) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, (0, riseSetTransitCalc_1.getRise)(this.constructor, location, this.jd0, standardAltitude)];
                    case 1:
                        jd = _a.sent();
                        return [2, time_1.createTimeOfInterest.fromJulianDay(jd)];
                }
    ...
    Moon.prototype.getSet = function (location, standardAltitude) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, (0, riseSetTransitCalc_1.getSet)(this.constructor, location, this.jd0, standardAltitude)];
                    case 1:
                        jd = _a.sent();
                        return [2, time_1.createTimeOfInterest.fromJulianDay(jd)];
                }
