...
function getElongation(equCoordsObj, equCoordsSun) {
    var raObjRad = (0, angleCalc_1.deg2rad)(equCoordsObj.rightAscension);
    var dObjRad = (0, angleCalc_1.deg2rad)(equCoordsObj.declination);
    var raSunRad = (0, angleCalc_1.deg2rad)(equCoordsSun.rightAscension);
    var dSunRad = (0, angleCalc_1.deg2rad)(equCoordsSun.declination);
...
function getPhaseAngle(equCoordsObj, equCoordsSun) {
    ...
    var phiRad = (0, angleCalc_1.deg2rad)(phi);
...
function getIlluminatedFraction(phaseAngle) {
    var iRad = (0, angleCalc_1.deg2rad)(phaseAngle);
...
function getAngularSeparation(coords1, coords2) {
    var raRad1 = (0, angleCalc_1.deg2rad)(coords1.rightAscension);
    var dRad1 = (0, angleCalc_1.deg2rad)(coords1.declination);
    var raRad2 = (0, angleCalc_1.deg2rad)(coords2.rightAscension);
    var dRad2 = (0, angleCalc_1.deg2rad)(coords2.declination);
