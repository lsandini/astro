...
function sec2string(sec, short) {
    ...
    var secPart = (0, math_1.round)(sec - hour * 3600 - min * 60, 2);
...
function dayOfYear2time(year, dayOfYear) {
    ...
    var sec = (0, math_1.round)(60 * (minFloat - min));
...
function getGreenwichMeanSiderealTime(T) {
    ...
    return (0, angleCalc_1.normalizeAngle)(GMST);
}
...
function getGreenwichApparentSiderealTime(T) {
    ...
    var p = calculations_1.earthCalc.getNutationInLongitude(T);
    var e = calculations_1.earthCalc.getTrueObliquityOfEcliptic(T);
    var eRad = (0, angleCalc_1.deg2rad)(e);
...
function getLocalMeanSiderealTime(T, lon) {
    var GMST = getGreenwichMeanSiderealTime(T);
    var LMST = GMST + lon;
    return (0, angleCalc_1.normalizeAngle)(LMST);
}
...
function getLocalHourAngle(T, lon, rightAscension) {
    ...
    return (0, angleCalc_1.normalizeAngle)(LAST - rightAscension);
}
