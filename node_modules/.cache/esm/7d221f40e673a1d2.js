let createTimeOfInterest,createMoon,createEarth,createMercury,createVenus,createMars,createJupiter,createSaturn,createNeptune;_e67‍.w("astronomy-bundle/time",[["createTimeOfInterest",["createTimeOfInterest"],function(v){createTimeOfInterest=v}]]);_e67‍.w("astronomy-bundle/moon",[["createMoon",["createMoon"],function(v){createMoon=v}]]);_e67‍.w("astronomy-bundle/earth",[["createEarth",["createEarth"],function(v){createEarth=v}]]);_e67‍.w("astronomy-bundle/planets",[["createMercury",["createMercury"],function(v){createMercury=v}],["createVenus",["createVenus"],function(v){createVenus=v}],["createMars",["createMars"],function(v){createMars=v}],["createJupiter",["createJupiter"],function(v){createJupiter=v}],["createSaturn",["createSaturn"],function(v){createSaturn=v}],["createNeptune",["createNeptune"],function(v){createNeptune=v}]]);const express = require("express");
...
app.post("/", (req, res) => {
  ...
  async function planets_now() {
    ...
    _e67‍.g.console.log("data.helio:", data);
  ...
  async function myFunc() {
    try {
        ...
        _e67‍.g.console.log("that failed", e); 
    } finally {
        console.log('excellent, that worked or maybe not!')
    }
};
myFunc();
  _e67‍.g.console.log("myDate:", myDate);
});
