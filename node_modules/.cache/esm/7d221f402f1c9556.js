let createTimeOfInterest,createMoon,createEarth,createMercury,createVenus,createMars,createJupiter,createSaturn,createNeptune;_2f1‍.w("astronomy-bundle/time",[["createTimeOfInterest",["createTimeOfInterest"],function(v){createTimeOfInterest=v}]]);_2f1‍.w("astronomy-bundle/moon",[["createMoon",["createMoon"],function(v){createMoon=v}]]);_2f1‍.w("astronomy-bundle/earth",[["createEarth",["createEarth"],function(v){createEarth=v}]]);_2f1‍.w("astronomy-bundle/planets",[["createMercury",["createMercury"],function(v){createMercury=v}],["createVenus",["createVenus"],function(v){createVenus=v}],["createMars",["createMars"],function(v){createMars=v}],["createJupiter",["createJupiter"],function(v){createJupiter=v}],["createSaturn",["createSaturn"],function(v){createSaturn=v}],["createNeptune",["createNeptune"],function(v){createNeptune=v}]]);const express = require("express");
...
mongoose.connect(mongodbUri, {}, (error) => {
  if (error) {
    _2f1‍.g.console.error('mongoose.connect error: %o', error);
  }
});

const db = mongoose.connection;
db.on(`error`, _2f1‍.g.console.error.bind(_2f1‍.g.console, `connection error: `));
...
app.post("/", (req, res) => {
  ...
  async function planets_now() {
    ...
    _2f1‍.g.console.log("data.helio:", data);
  ...
  async function myFunc() {
    try {
        ...
        _2f1‍.g.console.log("that failed", e); 
    } finally {
        console.log('excellent, that worked or maybe not!')
    }
};
myFunc();
  _2f1‍.g.console.log("myDate:", myDate);
});
...
app.get(`/refreshLastNSupdateDirect`, async (req, res) => {
  ...
  try {
    ...
    _2f1‍.g.console.error('Error fetching data from MongoDB:', error);
