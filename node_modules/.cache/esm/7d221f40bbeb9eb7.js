let createTimeOfInterest,createMoon,createEarth,createMercury,createVenus,createMars,createJupiter,createSaturn,createNeptune;_bbe‍.w("astronomy-bundle/time",[["createTimeOfInterest",["createTimeOfInterest"],function(v){createTimeOfInterest=v}]]);_bbe‍.w("astronomy-bundle/moon",[["createMoon",["createMoon"],function(v){createMoon=v}]]);_bbe‍.w("astronomy-bundle/earth",[["createEarth",["createEarth"],function(v){createEarth=v}]]);_bbe‍.w("astronomy-bundle/planets",[["createMercury",["createMercury"],function(v){createMercury=v}],["createVenus",["createVenus"],function(v){createVenus=v}],["createMars",["createMars"],function(v){createMars=v}],["createJupiter",["createJupiter"],function(v){createJupiter=v}],["createSaturn",["createSaturn"],function(v){createSaturn=v}],["createNeptune",["createNeptune"],function(v){createNeptune=v}]]);const express = require("express");
...
app.post("/", (req, res) => {
  ...
  async function planets_now() {
    ...
    _bbe‍.g.console.log("data.helio:", data);
  ...
  async function myFunc() {
    try {
        ...
        _bbe‍.g.console.log("that failed", e); 
    } finally {
        console.log('excellent, that worked or maybe not!')
    }
};
myFunc();
  _bbe‍.g.console.log("myDate:", myDate);
});
